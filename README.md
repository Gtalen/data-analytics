...
![Fig 1](PP Analysis Output/PP Cat Var Histogram.png)

['Table 1'](PP Analysis Output/Descriptive statistics.png) below is the summary statistics for the bill length, bill depth, flipper length and body mass of the penguins.
